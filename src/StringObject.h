...
class StringObject : public PatchObject {
...
class StringObjectDriver : public PatchObjectDriver
{
public:
    StringObjectDriver() : PatchObjectDriver("StringObjectDriver", StringObject::version) {}
    PatchObject* create() {return new StringObject();}
};
